...
class YelpCategory:
    """Organize data from Category JSON file"""
    ...
    with open(file_path) as the_file:
        ...
        for small_json_object in one_big_json_object:
            ...
            if row_count % 1000 == 0:
                ...
                print "Up to row {:} in Category file.  Total Time: {:.4g}; TimeSinceLastPost:{:.4g}" \
...
def persist_list_o_category_objects(list_o_ycos, cursor):
    """
    This function persists a list of YelpCategory objects.  Original implementations
...
def persist_category_object(yco, cursor):
    """
    Saves a single YelpCategory object to database.
    ...
    :param yco: A single YelpCategory object
    :param cursor: Open MySQLdb cursor
    """
    try:
        # categories
