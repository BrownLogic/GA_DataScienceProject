...
class YelpReview:
    """Organize data from Review JSON file"""
...
def persist_list_o_review_objects(list_o_yros, cursor):
    """
    This function persists a list of YelpReview objects.  Original implementations
    ...
    persist in batches
    :param list_o_yros: List of YelpReview objects
    :param cursor: Open MySQLdb cursor
    """
...
def persist_review_object(yro, cursor):
    ...
    :param yro: A single YelpReview object
    :param cursor: Open MySQLdb cursor
    """
    try:
        # Review
        ...
        print "Error with review_id {0}, business_id {1}, user_id {2}" \
            .format(yro.review_id, yro.business_id, yro.user_id)
